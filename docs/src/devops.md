...
这里用于整理 DevOps 和部署运维相关面试题，后续按 Nginx、CI/CD、日志、监控告警、灰度发布、回滚、Kubernetes 基础等方向追加。
...
## 3、Kubernetes 中 Pod、Deployment 和 Service 分别是什么
...
## 10、Kubernetes 中 requests 和 limits 有什么区别
...
## 16、livenessProbe、readinessProbe 和 startupProbe 有什么区别
...
## 17、Kubernetes 中 taint 和 toleration 有什么作用
...
## 18、Kubernetes StatefulSet 适合什么场景
